...
with tab_city:
    ...
    queries_city: list[tuple[str, str]] = [
        (
            "Emplacements dispo par ville",
            "select * from city_available_emplacement;",
        ),
...
with tab_department:
    ...
    queries_department: list[tuple[str, str]] = [
        (
            "Emplacements dispo par département",
            "select * from department_available_emplacement;",
        ),
        (
            "Capacité totale par département",
            "select * from department_total_capacity;",
        ),
        (
            "Statuts des stations par département",
            "select * from department_station_status;",
        ),
    ]
